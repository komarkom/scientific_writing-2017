### Аннотация
Этот материал посвящён выбору и планированию основы для многопоточных систем, сочетающей в себе потокобезопасность и отсутствие блокировок. В качестве примера готовой системы был выбран сервер для онлайн игры.
