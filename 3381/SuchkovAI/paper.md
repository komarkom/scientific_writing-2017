...
При решении задачи вычисления полинома большой степени вида ![equation](http://latex.codecogs.com/gif.latex?%5Clarge%20x%5EN) одним из основополагающих критериев, который определяет эффективность метода решения, является время. Целью данной работы является нахождение способов вычисления полиномов большой степени за минимальное число операций, а, следовательно, за короткое время.
...
Следующее определение было позаимствовано из [1, 2]. Аддитивной цепочкой для некоторого числа ![equation](https://latex.codecogs.com/gif.latex?%5Cdpi%7B120%7D%20%5Clarge%20N) называют последовательность натуральных чисел
...
где ![equation](https://latex.codecogs.com/gif.latex?%5Cdpi%7B120%7D%20%5Clarge%20%5Clambda%28N%29%20%3D%20%5Cleft%20%5Clfloor%20%5Clog_2N%20%5Cright%20%5Crfloor).
...
где ![equation](https://latex.codecogs.com/gif.latex?%5Cdpi%7B120%7D%20%5Clarge%20%5Coverline%20l%28N%29%20%3D%20%5Clambda%28N%29%20&plus;%20%5Cnu%28N%29%20-%201), ![equation](https://latex.codecogs.com/gif.latex?%5Cdpi%7B120%7D%20%5Clarge%20%5Cnu%28N%29) - вес Хэмминга для числа в бинарном представлении.

Чтобы понять, как разработать алгоритм, необходимо обратиться к аналогам. Алгоритмы, рассмотренные далее, наиболее известные и часто приминимые в различных областях вычислительной математики. Помимо этого они представляют заданное число в виде звёздной цепочки, которая является упрощённым видом аддитивной цепочки.
...
Время работы заданного алгоритма должно быть пропорционално логарифму искомого числа: ![equation](http://latex.codecogs.com/gif.latex?%5Clarge%20t%20%5Cpropto%20%5Clog%20N), [t] = сек.
...
Результаты сравнения аналогов по критериям представлена в табл. 1

Таблица 1 - Сравнение аналогов

Аналог\Критерий|Время работы|Точность выполнения|Стабильность алгоритма
-|-|-|-
Brauer's algorithm|+|-|+
Yao's algorithm|+|-|+
...
В качестве исследования были выбраны звёздные цепочки. Причины на это следующие:

1. уменьшают число сочетаний слагаемых: если для обычной аддитивной цепочки для получения требуется рассмотреть ![equation](http://latex.codecogs.com/gif.latex?%5Clarge%20%5Cbinom%20i2) возможных пар слагаемых, то для звёздной цепочки требуется всего лишь ![equation](https://latex.codecogs.com/gif.latex?%5Cdpi%7B120%7D%20%5Clarge%20i) слагаемых, поскольку одно из них у нас фиксировано;

2. при задании следующего определения, вычисление звёздных цепочек становится гораздо удобнее и проще.
