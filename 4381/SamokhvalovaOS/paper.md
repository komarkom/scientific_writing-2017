...
Разработано прилодение с интерфейсом пользователя для составления рекомендаций по сообществам в социальной сети ВКонтакте с использованием технологий Spring Boot и Angular 5.
