...
|   |                                             | Риск потери репутации из-за задержки поставки ПС.                       | 0,2*2,8+0,3*0,8+0,1*2,4+0,4*0,8=1.8 | Высокое отклонение от плана по срокам в ходе реализации ПС.                         | 2,8 | 0,2 | 0,1 | 0,4 | 7 |
